...
pubs_clean$Publisher[which(grepl("The Politics of Legislative Debates|Legislative Party Groups in the Storting", pubs_clean$Title))] <- "Oxford University Press"

pubs_clean <- pubs_clean[which(grepl("[Aa]rticle", pubs_clean$Type)), ]
